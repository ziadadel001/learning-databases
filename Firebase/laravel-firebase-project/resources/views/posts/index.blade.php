                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('posts.destroy',$id) }}" method="POST">
                            ...
                            <a class="btn btn-info btn-sm" href="{{ route('posts.show',$id) }}"><i class="fa-solid fa-list"></i> Show</a>
            
                            <a class="btn btn-primary btn-sm" href="{{ route('posts.edit',$id) }}"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
